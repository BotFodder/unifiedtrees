...
/*
 +-------------------------------------------------------------------------+
 | Modified for use in Unified Trees.  This should make the thing a bit    |
 | more portable and remove the need for patching.  However, when the      |
 | original changes, we should look at it and patch this file.             |
 +-------------------------------------------------------------------------+
*/
...
/* Here's what we changed.
				grow_dhtml_trees();
*/
				include_once($config["base_path"] . '/plugins/unifiedtrees/unifiedtrees.php');
			?>
		</td>
		<?php } ?>
		<td class='cactiGraphContentArea' valign="top"><div style='position:static;' id='main'>
<?php print "<!-- end unifiedtrees -->\n";
?>
